...
// StoreVerified saves the chunked manifest to the cache without re-reading the
// chunks. Callers must only use this after verifying that the ordered chunk
// bytes hash to BlobDigest.
