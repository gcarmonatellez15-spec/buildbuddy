  ...
  render() {
    ...
    return (
      <Banner type={bannerType(prompt.urgency)} className="upgrade-prompt-banner">
        {prompt.message || "One or more components of your installation is running an outdated version."} The newest
        available version is <b>{prompt.newestAvailableVersion}</b>.
      </Banner>
    );
  }
}
